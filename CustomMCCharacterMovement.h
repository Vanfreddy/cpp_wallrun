...
#include "CustomMCCharacterMovement.generated.h"


UCLASS()
class UCustomMCCharacterMovement : public UCharacterMovementComponent
{
	GENERATED_BODY()

public:
	UCustomMCCharacterMovement(const FObjectInitializer& ObjectInitializer);

	friend class FSavedMove_CustomMCCharacter;

	FCustomMCCharacterNetworkMoveDataContainer NetworkMoveDataContainer;
